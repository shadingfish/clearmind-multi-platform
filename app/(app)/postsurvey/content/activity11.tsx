...
const Activity11 = () =>{
    ...
    }, [ques47, ques48, ques49, ques50, ques51]); */ 
    ...
    useEffect(() => {
      if (user) {
        console.log('getPostsurveyActivity11')
        getPostsurveyActivity(user.uid, "Activity11")
          .then((snapshot) => {
            if (snapshot.exists()) {
          ...
          .catch((err) => console.log("Error get postsurvey activity11:", err));
      }
    }, [pending]);
    ...
    return (
            ...
            <View>
                <View style={{...styles.radioGroup}}>
                    ...
                    <View style={styles.radioButton}>
                        ...
                        key={option}
                        value={option}
                        status={data?.ques47 === option ? 'checked' : 'unchecked'}
                        onPress={() => updateQuestion("ques47", option)} // Set the selected gender
                        color="#1EB688"
                        />
            ...
            <View>
                    <View style={{...styles.radioGroup}}>
                        ...
                        <View style={styles.radioButton}>
                            ...
                            key={option}
                            value={option}
                            status={data?.ques48 === option ? 'checked' : 'unchecked'}
                            onPress={() => updateQuestion("ques48", option)} // Set the selected gender
                            color="#1EB688"
                            />
                            <Text style={styles.radioLabel}>
                                {option}
            ...
            <View>
                    <View style={{...styles.radioGroup}}>
                        ...
                        <View style={styles.radioButton}>
                            ...
                            key={option}
                            value={option}
                            status={data?.ques49 === option ? 'checked' : 'unchecked'}
                            onPress={() => updateQuestion("ques49", option)} // Set the selected gender
                            color="#1EB688"
                            />
                            <Text style={styles.radioLabel}>
                                {option}
            ...
            <View>
                    <View style={{...styles.radioGroup}}>
                        ...
                        <View style={styles.radioButton}>
                            ...
                            key={option}
                            value={option}
                            status={data?.ques50 === option ? 'checked' : 'unchecked'}
                            onPress={() => updateQuestion("ques50", option)} // Set the selected gender
                            color="#1EB688"
                            />
                            <Text style={styles.radioLabel}>
                                {option}
            ...
            <View>
                <View style={{...styles.radioGroup}}>
                    ...
                    <View style={styles.radioButton}>
                        ...
                        key={option}
                        value={option}
                        status={data?.ques51 === option ? 'checked' : 'unchecked'}
                        onPress={() => updateQuestion("ques51", option)} // Set the selected gender
                        color="#1EB688"
                        />
                        <Text style={styles.radioLabel}>
                            {option}
        ...
        <ChapterNavigationButton
            prev={"/(app)/postsurvey/content/activity10"}
            next={() => {if (hasEmptyValues(data)) {
                toast.show("Empty Input");
            } else {
                setPostsurveyActivity(user!.uid, data, "Activity11");
                router.push("/(app)/postsurvey/content/activity12" as RelativePathString);
            }
            }}
        />
