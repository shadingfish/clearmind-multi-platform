...
const Activity1 = () => {
    ...
    useEffect(() => {
      if (user) {
        console.log('getPostsurveyActivity1')
        getPostsurveyActivity(user.uid, "Activity1")
          .then((snapshot) => {
            if (snapshot.exists()) {
          ...
          .catch((err) => console.log("Error get postsurvey activity1:", err));
      }
    }, [pending]);
        ...
        <View>
            ...
            <ChapterNavigationButton
                ...
                next={() => {if (hasEmptyValues(data)) {
                    ...
                    setPostsurveyActivity(user!.uid, data, "Activity1");
                    router.push("/(app)/postsurvey/content/activity2" as RelativePathString);
                }
                }}
            />
        </YStack>
