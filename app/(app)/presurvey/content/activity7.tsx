...
const Activity7 = () =>{
    ...
    const [ques29, setQues29] = useState<string>("");
    const [ques30, setQues30] = useState<string>("");
    const [ques31, setQues31] = useState<string>("");
    ...
    return (
        ...
        <ChapterNavigationButton
            prev={"/(app)/presurvey/content/activity6"}
