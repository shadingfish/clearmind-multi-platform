...
const CogDistortModal: React.FC<CogDistortModalProps> = ({
  isVisible,
  onClose,
  title,
}) => {
  const label2description: Record<string, string> = {
    Specific:
      'You need to be specific about your goal because vague goals can make success feel out of reach. Being specific helps you plan effectively and narrow your focus to what truly matters. For example, instead of setting a vague goal like "I want to be fit," a specific goal would be "I want to lose 20 pounds within three months through daily 30-minute exercise sessions and maintaining a balanced diet."',
    Trackable:
