...
export default function SignupScreen() {
  ...
  const handleSubmit = async () => {
    const { username, password, fullName, email, question1, answer1, question2, answer2, hasTherapyExperience, therapyDetails, learningExpectation } = formData;
    ...
    if (!hasTherapyExperience) newErrors.hasTherapyExperience = "Please select therapy experience.";
    if (!learningExpectation) newErrors.learningExpectation = "Please fill out learning expectations.";
    ...
    >
      ...
      <YStack flex={1} alignItems="center" width="100%" gap="$2">
        ...
        <RadioGroup
          ...
          onValueChange={(value) => updateFormData("hasTherapyExperience", value)}
