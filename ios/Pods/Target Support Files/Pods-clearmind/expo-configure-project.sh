...
with_node \
  ...
  --target "/Users/maduryasuresh/Desktop/clearmind/ios_ver/clearmind-multi-platform/ios/Pods/Target Support Files/Pods-clearmind/ExpoModulesProvider.swift" \
  --entitlement "/Users/maduryasuresh/Desktop/clearmind/ios_ver/clearmind-multi-platform/ios/clearmind/clearmind.entitlements" \
  --platform "apple" \
  --packages "@react-native-google-signin/google-signin" "burnt" "expo" "expo-asset" "expo-blur" "expo-constants" "expo-dev-launcher" "expo-dev-menu" "expo-file-system" "expo-font" "expo-haptics" "expo-keep-awake" "expo-linear-gradient" "expo-linking" "expo-router" "expo-splash-screen" "expo-symbols" "expo-system-ui" "expo-web-browser"
